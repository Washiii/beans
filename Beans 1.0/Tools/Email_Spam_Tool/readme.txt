...
in case of errors send me a pm with them :)

If you want to put emails in 'email_list.txt' separate the email and password using a space. One email and pass for each line.
